...
public class ServImplem implements Serv {
	 ...
	 */
	public synchronized int clientRegister(Client c) throws RemoteException {
		int cId;
	 ...
	 * @param c : Client
	 */
	public synchronized void clientLeave(Client c) throws RemoteException {
		for(Room r : getRooms())
			if(r.isInTheRoom(c)) {
				r.leaveRoom(c);
	 ...
	 */
	public synchronized void sendMsgToServ(Message m) throws RemoteException {
	 ...
	 */
	private synchronized void sendMsgToRoom(Message m, Room room){
	...
	// HISTORY
	/////////////////////////////////////////////////////////////////////////////////////
	private synchronized void writeToHistory(Message m) {
	 ...
	 */
	public synchronized ArrayList<Message> getHistory(Client c) throws RemoteException {
	 ...
	 */
	public synchronized String printRooms() throws RemoteException{
	 ...
	 */
	public synchronized void changeRoom(Client c, int newRoomId) throws RemoteException{
